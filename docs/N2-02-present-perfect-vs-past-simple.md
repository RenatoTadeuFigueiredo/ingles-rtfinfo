# N2-02 — Present Perfect vs Past Simple
...
A escolha é simples: se a frase diz (ou subentende) **quando** aconteceu, é **past simple**; se o que importa é a **conexão com agora** (experiência, resultado, período ainda aberto), é **present perfect**.
...
Na maioria das frases, uma palavrinha de tempo já entrega a resposta:

| 🟢 Pedem **present perfect** | 🔵 Pedem **past simple** |
|------------------------------|--------------------------|
| ever, never | yesterday, last night/week/year |
| just, already, yet | ... ago (two days ago) |
| for, since | in 2020, in May, on Monday |
...
> ⚠️ **When...?** sempre pede past simple, porque pergunta exatamente o "quando": *When **did** you arrive?* (❌ *When have you arrived?*)

### Período terminado vs período ainda aberto

Expressões como *today, this week, this morning, this year* podem ir para os dois lados — depende de o período **já ter acabado ou não** no momento da fala:
...
- **Speaking Part 1 e 2**: perguntas como *"Have you ever...?"* ou *"Describe a trip you have enjoyed"* testam exatamente essa troca — responda com present perfect e desenvolva os detalhes em past simple (padrão acima). Fazer essa troca com naturalidade conta pontos em *Grammatical Range and Accuracy*.
- **Writing Task 2**: present perfect serve para tendências até hoje (*Technology **has changed** the way we work*); past simple para fatos datados (*In the past, people **wrote** letters*).
- Erros como *"I have visited in 2023"* são exatamente o tipo de coisa que segura a banda em 5.0 — dominar esse contraste é um dos saltos mais baratos rumo ao 5.5/6.0.

### Por que confunde brasileiro

O português usa **o mesmo pretérito perfeito** para os dois casos — a distinção simplesmente não existe na nossa gramática:
...
> Macete: antes de falar, pergunte-se **"a frase diz quando?"**. Disse quando (ou perguntou *when*) → past simple. Não disse e o que importa é agora → present perfect.
...
| Tipo | Fonte | Onde |
|------|-------|------|
| 📖 Referência | Perfect English Grammar — Present Perfect or Past Simple? | <https://www.perfect-english-grammar.com/present-perfect-or-past-simple.html> |
| ✏️ Exercícios | ego4u — Simple Past vs Present Perfect (exercícios) | <https://www.ego4u.com/en/cram-up/grammar> |
| 📕 Livro | English Grammar in Use (Murphy, azul) — unidades sobre present perfect and past (I have done / I did) | Livro |
| 📖 Consulta | Cambridge Grammar — Present perfect simple vs past simple | <https://dictionary.cambridge.org/grammar/british-grammar/> |
| ✏️ Exercícios extra | Agendaweb — present perfect vs past simple | <https://agendaweb.org> |
| 🎥 Vídeo EN | mmmEnglish (Emma) — Present Perfect vs Past Simple | YouTube: @mmmEnglish_Emma |
| 🎥 Vídeo PT-BR | SmallAdvantages — present perfect vs passado | YouTube: @SmallAdvantages |

## Revisão rápida (5 min)

- [ ] Recite a regra de ouro: **disse quando → past simple · importa o agora → present perfect**
- [ ] Recite 4 sinalizadores de cada lado (ever/just/for/since vs yesterday/ago/in 2020/when)
- [ ] *When...?* **sempre** pede past simple
- [ ] Fale em voz alta o padrão de conversa: *Have you ever been to...? — Yes, I went there last year and it was great.*
- [ ] Crie 2 frases sobre sua semana: uma com período aberto (*this week I have...*) e uma fechada (*last week I...*)
- [ ] Armadilha nº 1: **nunca** present perfect com *yesterday / ago / in + ano* — se escapou uma, revise [N2-01] antes de seguir
