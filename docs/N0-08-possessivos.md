...
### Os adjetivos possessivos: um para cada pronome

Cada pronome pessoal (N0-02) tem o seu possessivo correspondente. Eles **nunca mudam**: não têm plural nem masculino/feminino.
...
### O pulo do gato: concorda com o DONO, não com a coisa

Em português, o possessivo concorda com a **coisa possuída**: "minh**a** cas**a**", "me**u** carr**o**". Em inglês, ele concorda com o **dono** — e a coisa não importa:

| Português | Inglês | Por quê |
|-----------|--------|---------|
| o carro **dele** | **his** car | dono = homem → his |
| o carro **dela** | **her** car | dona = mulher → her |
| a casa **dele** | **his** house | dono = homem → his (mesmo "casa" sendo feminina) |

Por isso o "seu/sua" do português é uma armadilha: *o telefone dela* = **her** phone (nunca *his*, mesmo "telefone" sendo masculino). Pergunte sempre: **quem é o dono?**

### Sem artigo antes do possessivo

Em português dá para dizer "**a** minha casa". Em inglês, **nunca** use *the* (nem *a/an*) junto com possessivo — é um ou outro:

- ❌ *the my house* → ✅ ***my** house*
- ❌ *a her friend* → ✅ ***her** friend*

### O 's: posse com nomes de pessoas

Quando o dono tem nome (ou é uma pessoa/animal), o inglês cola **'s** no dono — e o dono vem **primeiro**, ao contrário do português:
...
### 's no singular, ' no plural

| Caso | Regra | Exemplo | Tradução |
|------|-------|---------|----------|
| Dono no singular | **'s** | my **brother's** bike | a bicicleta do meu irmão (1 irmão) |
| Dono no plural com -s | só **'** | my **brothers'** bikes | as bicicletas dos meus irmãos (2+) |
| Plural irregular | **'s** | the **children's** toys | os brinquedos das crianças |
| Nome terminado em -s | **'s** (mais comum) | **Carlos's** house | a casa do Carlos |

### Pessoas usam 's, coisas usam "of"
...
### Os três "s": não confunda

O apóstrofo + s aparece em três situações diferentes — e brasileiro mistura as três:
...
### Bônus: mine, yours... (quando a coisa some da frase)

Quando você **não repete** o substantivo, o possessivo muda de forma — são os **pronomes possessivos**:

| Adjetivo (+ coisa) | Pronome (sem coisa) | Exemplo |
|--------------------|---------------------|---------|
| my | **mine** | This bag is **mine**. — Esta bolsa é **minha**. |
| your | **yours** | Is this seat **yours**? — Este lugar é **seu**? |
| his | **his** (igual) | The blue car is **his**. — O carro azul é **dele**. |
| her | **hers** | That phone is **hers**. — Aquele telefone é **dela**. |
| our | **ours** | The flat on the left is **ours**. — O apartamento da esquerda é **nosso**. |
| their | **theirs** | The dog is **theirs**. — O cachorro é **deles**. |

E para perguntar "de quem é?", use **Whose**: *Whose bag is this? — It's **mine**.* (De quem é esta bolsa? — É minha.)
...
| Tipo | Fonte | Onde |
|------|-------|------|
| 📖 Referência | Perfect English Grammar — Possessive Adjectives | <https://www.perfect-english-grammar.com/possessive-adjectives.html> |
| 📖 Referência | Perfect English Grammar — Possessive Pronouns (mine, yours) | <https://www.perfect-english-grammar.com/possessive-pronouns.html> |
| ✏️ Exercícios | ego4u — Grammar (Possessive adjectives / possessive 's) | <https://www.ego4u.com/en/cram-up/grammar> |
| ✏️ Exercícios | Agendaweb — possessives (vários níveis) | <https://agendaweb.org> |
| 📕 Livro | Essential Grammar in Use (Murphy, vermelho) — unidades sobre my/your/their, whose e o 's | Livro |
| 📖 Consulta | Cambridge Grammar — Possession (John's car) | <https://dictionary.cambridge.org/grammar/british-grammar/possession-john-s-car-a-friend-of-mine> |
| 🎥 Vídeo PT-BR | SmallAdvantages — possessivos em inglês | YouTube: @SmallAdvantages |
| 🎥 Vídeo EN | BBC Learning English — possessives | YouTube: @bbclearningenglish |
