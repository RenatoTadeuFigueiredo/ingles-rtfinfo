# N0-05 — Artigos (a / an / the)

> **Nível:** N0 Fundação (A1) · **Trilha:** Gramática
> **Requer:** N0-04 Estrutura da frase: Sujeito-Verbo-Objeto
> **Destrava:** N0-06 Substantivos e plural

## Em 1 frase

**A/an** = "um/uma" qualquer (não específico), **the** = "o/a" que os dois sabem qual é — e muitas vezes o inglês usa **artigo nenhum** onde o português usaria "o/a".

## Explicação completa

### Os três "modos": a/an, the e ∅ (sem artigo)

| Artigo | Significado | Exemplo | Tradução |
|--------|-------------|---------|----------|
| **a / an** | um/uma qualquer, 1ª menção | I saw **a** kangaroo. | Vi **um** canguru (qualquer um). |
| **the** | aquele específico, já conhecido | **The** kangaroo was huge. | **O** canguru (aquele) era enorme. |
...
**An** antes de **som de vogal**; **a** antes de **som de consoante**. Olhe para a pronúncia, não para a escrita:

| ✅ Certo | Por quê |
|---------|---------|
| **an** apple, **an** engineer, **an** umbrella | começa com som de vogal |
| **a** house, **a** beach, **a** job | começa com som de consoante |
| **an** hour /áuer/ | o **h é mudo** — o som começa em vogal |
| **a** university /iúniversity/ | u aqui soa como "iú" — som de consoante (y) |
| **a** one-way ticket /uan/ | "one" começa com som de "u→w" — consoante |

> Macete: fale a palavra em voz alta. Se a boca abre em vogal, é **an**.
...
**1. Os dois sabem de qual coisa se trata (já mencionado ou óbvio pelo contexto)**
- *Can you close **the** door?* — Fecha **a** porta? (a porta desta sala, óbvio)
- ***The** course starts in July.* — **O** curso (aquele que a gente já falou) começa em julho.
...
- *I have ∅ breakfast at 7.* — Tomo **o** café da manhã às 7.
- *She speaks ∅ English and ∅ Portuguese.* — Ela fala inglês e português.

**4. Lugares de rotina: home, work, school, bed**
- *I go to ∅ work by train.* · *She's at ∅ home.* · *Time for ∅ bed.*

**5. Depois de possessivos — nunca artigo + possessivo juntos**
- *∅ my house* (❌ ~~the my house~~) — **a** minha casa.

### Contraste com o português: o mapa mental

O português usa artigo definido **muito mais** que o inglês. A tradução literal quase sempre sobra "the":
...
| Tipo | Fonte | Onde |
|------|-------|------|
| 📖 Referência | Perfect English Grammar — seção de artigos (a/an/the) | <https://www.perfect-english-grammar.com> |
| ✏️ Exercícios | ego4u — Grammar (seção Articles) | <https://www.ego4u.com/en/cram-up/grammar> |
| 📕 Livro | Essential Grammar in Use (Murphy, vermelho) — unidades sobre a/an e the | Livro |
| 📖 Consulta | Cambridge Grammar — A/an and the | <https://dictionary.cambridge.org/grammar/british-grammar/a-an-and-the> |
| ✏️ Exercícios extra | Agenda Web — exercícios de articles | <https://agendaweb.org> |
| 🎥 Vídeo PT-BR | SmallAdvantages — artigos em inglês | YouTube: @SmallAdvantages |
| 🎥 Vídeo EN | mmmEnglish (Emma) — Articles a/an/the | YouTube: @mmmEnglish_Emma |
