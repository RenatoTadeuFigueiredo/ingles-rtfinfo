...
> **Requer:** N0-13 Can / Can't (habilidade e permissão)
> **Destrava:** N2-05 Primeira condicional (futuro real) · N3-12 Futuro contínuo e futuro perfeito

## Em 1 frase

**Will + verbo** é o jeito mais simples de falar do futuro em inglês — serve para **previsões, decisões tomadas na hora, promessas e ofertas** — e nunca muda de forma, nem na 3ª pessoa.
...
```
SUJEITO + WILL + VERBO (sem to, sem -s)

I/You/He/She/It/We/They  will  help.
```

**Will é igual para todo mundo** — não existe *he wills* nem *will helps*. Na fala, quase sempre vira a contração **'ll**; a negativa **will not** vira **won't**.
...
- *I'm tired. I**'ll take** the bus instead of walking.* — Tô cansada. Vou de ônibus em vez de andar.

**3. Promessas e ameaças**
- *I **promise** I**'ll study** English every day.* — Prometo que vou estudar inglês todo dia.
- *I **won't tell** anyone.* — Não vou contar pra ninguém.

**4. Ofertas e pedidos**
- *I**'ll carry** your bags.* — Eu levo suas malas. (oferta)
- ***Will** you **open** the door, please?* — Você abre a porta, por favor? (pedido)

### A tradução que engana: "vou" nem sempre é will

Em português, o futuro do dia a dia é "**vou** + verbo" ("vou viajar", "vou ligar"). A tentação é traduzir "vou" como *go* — **não caia nessa**:

| Português | ❌ Tradução literal | ✅ Inglês |
|-----------|---------------------|-----------|
| Vou te ligar amanhã. | *I go call you tomorrow.* | *I**'ll call** you tomorrow.* |
| Te ajudo com isso. | *I help you with that.* | *I**'ll help** you with that.* |
| Ela não vai gostar. | *She no will like.* | *She **won't like** it.* |

> Repare no segundo exemplo: o português usa **presente** para futuro ("te ajudo", "te ligo"). O inglês **não faz isso** — futuro pede *will* (ou *going to*).

### Will vs going to: o resumo essencial

Os dois falam do futuro, mas com atitudes diferentes:
...
**Won't** também significa "se recusa a" — inclusive para coisas:
- *He **won't listen** to me.* — Ele não quer me ouvir.
- *The car **won't start**.* — O carro não pega. (se recusa a funcionar)
...
| Tipo | Fonte | Onde |
|------|-------|------|
| 📖 Referência | Perfect English Grammar — Future Simple (will) | <https://www.perfect-english-grammar.com/future-simple.html> |
| ✏️ Exercícios | ego4u — Future I (will) | <https://www.ego4u.com/en/cram-up/grammar/future-1-will> |
| ✏️ Exercícios | Agendaweb (Verb tenses → Future: will) | <https://agendaweb.org> |
| 📕 Livro | Essential Grammar in Use (Murphy, vermelho) — unidades sobre will/shall | Livro |
| 📖 Consulta | Cambridge Grammar — Will | <https://dictionary.cambridge.org/grammar/british-grammar/> |
| 🎥 Vídeo EN | mmmEnglish (Emma) — will e futuro | YouTube: @mmmEnglish_Emma |
| 🎥 Vídeo PT-BR | SmallAdvantages — futuro em inglês (will vs going to) | YouTube: @SmallAdvantages |

## Revisão rápida (5 min)

- [ ] Recite a forma: **will + verbo puro** (sem to, sem -s) — igual para todas as pessoas
